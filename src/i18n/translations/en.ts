export const enTranslation = {
  ...
  about: {
    ...
    otaVersionLabel: 'OTA Patch {{version}}',
    otaVersionValue: '{{channel}} · {{patchId}}',
    otaVersionEmbedded: 'no OTA patch yet',
    otaBuildDateLabel: 'Patch date {{date}}',
  ...
  notifications: {
    ...
    permissionCardTitle: 'Notification Permission',
    permissionCardDescription: 'Enable notification permission first so fasting reminders and test notifications can work properly.',
    requestPermissionButton: 'Request Permission',
    openSettingsButton: 'Open Settings',
    cancelButton: 'Later',
    permissionGrantedTitle: 'Permission Enabled',
    permissionGrantedMessage: 'Notification permission is active. You can now use fasting reminders.',
